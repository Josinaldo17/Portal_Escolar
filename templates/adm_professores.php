...
try {
    ...
    $stmt = $pdo->query("SELECT matricula_usuario, telefone, nome, nas, cpf FROM professores ");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown" style="justify-content: center;">
                     ...
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  active" href="../templates/adm_professores.php">Professores</a>
                        </li>
    ...
    <main class="Main">
        ...
        <div class="div-main row">
            ...
            <div class="col-lg">
                    ...
                    <img src="../img/img-professores.png" >
                ...
                <?php foreach ($professores as $professor): ?>
                    <div class="div-dados-usuarios">
                        ...
                        <div class="col-9">
                            ...
                            <label>
                                <?= htmlspecialchars($professor['matricula_usuario']) ?>
                            </label>
            ...
            <div class="modal fade" id="modalEdicao" tabindex="-1" aria-labelledby="modalEdicaoLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEdicaoLabel">Editar informações de professores</h5>
