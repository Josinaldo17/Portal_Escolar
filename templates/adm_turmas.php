...
try {
    ...
    $stmt = $pdo->query("SELECT t.id AS id_turma, d.nome AS nome_disciplina, p.nome AS nome_professor, s.nome AS nome_sala, t.periodo_ano, t.status FROM escola.turmas t INNER JOIN escola.disciplinas d ON t.id_disciplinas = d.id INNER JOIN escola.professores p ON t.id_professor = p.matricula_usuario INNER JOIN escola.salas s ON t.id_salas = s.id");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown" style="justify-content: center;">
                     ...
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../templates/adm_turmas.php">Turmas</a>
                        </li>
                ...
                <?php foreach ($turmas as $turma): ?>
                    ...
                    <div class="div-dados-usuarios">
                        ...
                        <div class="col-9">
                             ...
                             <label>
                                <?= htmlspecialchars($turma['nome_sala']) ?>
                            </label>
                            <br>

                            <label>
                                <?= htmlspecialchars($turma['nome_disciplina']) ?>
                            </label>
