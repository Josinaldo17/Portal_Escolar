...
try {
    ...
    $stmt = $pdo->query("SELECT matricula_usuario, telefone, nome, nas, cpf FROM responsaveis ");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown" style="justify-content: center;">
                     ...
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../templates/adm_responsaveis.php">Responsaveis</a>
                        </li>
    ...
    <main class="Main">
        ...
        <div class="div-main row">
            ...
            <div class="col-lg">
                    ...
                    <img src="../img/img-responsaveis.png" >
                ...
                <?php foreach ($responsaveis as $responsavel): ?>
                    <div class="div-dados-usuarios">
                        ...
                        <div class="col-9">
                            ...
                            <label>
                                <?= htmlspecialchars($responsavel['matricula_usuario']) ?>
                            </label>
            ...
            <div class="modal fade" id="modalEdicao" tabindex="-1" aria-labelledby="modalEdicaoLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEdicaoLabel">Editar informações de responsaveis</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                        <label for="nas" class="form-label">Nascimento</label>
