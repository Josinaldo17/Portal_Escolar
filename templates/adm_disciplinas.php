...
try {
    ...
    $stmt = $pdo->query("SELECT id, nome FROM disciplinas");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown" style="justify-content: center;">
                     ...
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  active" href="../templates/adm_disciplinas.php">Disciplinas</a>
                        </li>
    ...
    <main class="Main">
        ...
        <div class="div-main row">
            ...
            <div class="col-lg">
                    ...
                    <img src="../img/img-disciplinas.png" >
            ...
            <div class="modal fade" id="modalEdicao" tabindex="-1" aria-labelledby="modalEdicaoLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEdicaoLabel">Editar informações da disciplina</h5>
